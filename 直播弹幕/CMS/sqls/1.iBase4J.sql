...
-- 导出 deehow 的数据库结构
CREATE DATABASE IF NOT EXISTS `deehow` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `deehow`;

-- 导出  表 deehow.sys_article 结构
...
-- 正在导出表  deehow.sys_dept 的数据：~3 rows (大约)
...
INSERT INTO `sys_dept` (`id_`, `unit_id`, `dept_name`, `parent_id`, `sort_no`, `leaf_`, `enable_`, `remark_`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES
	(1, 1, 'deehow', 0, 1, 0, 1, 'qw', 1, '2016-06-28 18:04:06', 1, '2016-06-28 18:04:06'),
...
-- 正在导出表  deehow.sys_dic 的数据：~43 rows (大约)
...
-- 正在导出表  deehow.sys_email 的数据：~0 rows (大约)
...
-- 导出  表 deehow.sys_email_config 结构
...
-- 正在导出表  deehow.sys_email_config 的数据：~0 rows (大约)
...
INSERT INTO `sys_email_config` (`id_`, `smtp_host`, `smtp_port`, `send_method`, `sender_name`, `sender_account`, `sender_password`, `remark_`, `enable_`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES
	(828157583909109760, 'smtp.163.com', '101', '0', 'deehow', 'deehow@163.com', 'BK5sgjz5JOOsFuD4w0mbe7==', NULL, 1, 1, '2017-02-05 16:25:29', 1, '2017-02-05 16:37:50');
/*!40000 ALTER TABLE `sys_email_config` ENABLE KEYS */;

-- 导出  表 deehow.sys_email_template 结构
...
-- 正在导出表  deehow.sys_news 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `sys_news` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_news` ENABLE KEYS */;

-- 导出  表 deehow.sys_notice 结构
...
-- 正在导出表  deehow.sys_notice 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `sys_notice` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_notice` ENABLE KEYS */;

-- 导出  表 deehow.sys_param 结构
...
-- 正在导出表  deehow.sys_param 的数据：~1 rows (大约)
/*!40000 ALTER TABLE `sys_param` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_param` ENABLE KEYS */;

-- 导出  表 deehow.sys_role 结构
...
-- 正在导出表  deehow.sys_role 的数据：~0 rows (大约)
...
-- 正在导出表  deehow.sys_unit 的数据：~1 rows (大约)
...
INSERT INTO `sys_unit` (`id_`, `unit_name`, `principal_`, `phone_`, `address_`, `sort_`, `enable_`, `remark_`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES
	(1, 'deehow', '经理', '13945678911', '中国', 1, NULL, NULL, '2017-01-12 00:00:00', 1, '2017-01-28 23:51:57', 1);
/*!40000 ALTER TABLE `sys_unit` ENABLE KEYS */;

-- 导出  表 deehow.sys_user 结构
...
-- 正在导出表  deehow.sys_user 的数据：~2 rows (大约)
...
-- 正在导出表  deehow.sys_user_role 的数据：~0 rows (大约)
...
-- 导出  表 deehow.sys_user_thirdparty 结构
...
-- 正在导出表  deehow.task_fire_log 的数据：~0 rows (大约)
