package com.deehow.core.support.scheduler;
...
import com.deehow.core.Constants.JOBSTATE;
import com.deehow.core.support.email.Email;
import com.deehow.core.support.mq.QueueSender;
import com.deehow.core.util.EmailUtil;
import com.deehow.core.util.NativeUtil;
import com.deehow.model.TaskFireLog;
		...
		executorService.submit(new Runnable() {
			public void run() {
				if (emailQueueSender != null) {
					emailQueueSender.send("deehow.emailSender", email);
				} else {
